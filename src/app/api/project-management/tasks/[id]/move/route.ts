...
import { TaskMoveService } from "@/modules/project-management/tasks/services/task-move-service";
import { MoveTaskSchema } from "@/modules/project-management/tasks/types/pm-task.schema";
 ...
 *
 * `PATCH /api/project-management/tasks/<id>/move` with body `MoveTaskSchema`:
