import { isTrueFlag } from "@/modules/project-management/task-configuration/services/task-config-policy";
import type { ScopedAttachmentRow, ScopedConfigRow } from "@/modules/project-management/services/scoping";
import type { PermissionContext } from "@/modules/project-management/services/permission-service";
import type { CatalogLists } from "@/modules/project-management/task-configuration/services/task-config-service";
...
/** The GET payload: the department's flat rows plus the catalogs their labels resolve from. */
