...
import type { MemberGrantItem } from "@/modules/project-management/assignment-grants/hooks/useAssignmentGrants";
...
export function TaskFormDialog({
    ...
    const handleSubmit = form.handleSubmit(async (values) => {
        ...
        if (task !== null) {
            const saved = await onUpdate(task.id, fields);
            if (!saved) return;
            ...
            const createdId = await onCreate({ ...fields, parent_id: parent?.id ?? null });
